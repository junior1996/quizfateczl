...
A-<input type="radio" name="ask1" value="0" required> Matematica Discreta , Banco de Dados e Sociedade e Técnolgia<p>
...
A-<input type="radio" name="ask2" value="0" required> Antonio Satoshi<p>
